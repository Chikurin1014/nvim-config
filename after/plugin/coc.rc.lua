...
vim.g.coc_global_extensions = {
    ...
    'coc-vimlsp',
    'coc-lua',
    'coc-ccls', -- requires: `cd ~/.config/coc/extensions/node_modules/coc-ccls && ln -s node_modules/ws/lib lib`
    'coc-rust-analyzer',
    'coc-docker'
}
...
-- Autocomplete
-- use TAB and S-TAB to select completion and use Enter to confirm it
